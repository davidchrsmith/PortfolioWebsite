...
export const AnimatedBorderButton = ({ children, href, ...rest }) => {
  // Determine the type of element to render based on the presence of href
  ...
  return (
    <Type
      className="relative bg-transparent border border-border 
        ...
        animated-border inline-flex" href={href} {...rest} target="_blank" rel="noopener noreferrer"
    >
      {/* Animated SVG Border */}
      <svg
